/*
  ...
  Modified for compatibility with Embedded Adventure's MOD-1016 by Juha Virtanen (juha.virtanen [at] rxtx-designs.com).
...
//    Serial.println("Tuning out of range, check your wiring, your sensor and make sure physics laws have not changed!");
  AS3935.tune(5);  // The number I used here (5) came on the packaging
